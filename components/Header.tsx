    ...
    <div className={twMerge("h-fit bg-gradient-to-b from-emerald-800 p-6")}>
      <div className="w-full mb-4 flex items-center justify-between">
        <div className="hidden md:flex gap-x-2 items-center">
            ...
            className="rounded-full bg-[#123] flex items-center justify-center hover:opacity-75 transition">
        ...
        <div className="flex md:hidden gap-x-2 items-center">
            <button className="rounded-full p-2 bg-white items-center justify-center hover:opacity-75 transition">
                <HiHome className="text-[#123]" size={20}/>
            </button>
       
            <button className="rounded-full p-2 bg-white items-center justify-center hover:opacity-75 transition">
                <BiSearch className="text-[#123]" size={20}/>
            </button>
        </div>
